...
class DeleteNonexistingFlow(base_tests.SimpleDataPlane):
    ...
    def runTest(self):
        ...
        response = self.controller.poll(exp_msg=ofp.OFPT_ERROR, timeout=2)
...
class SendFlowRem(base_tests.SimpleDataPlane):
    ...
    def runTest(self):
        ...
        response1 = self.controller.poll(exp_msg=ofp.OFPT_FLOW_REMOVED, timeout=2)
        ...
        response2 = self.controller.poll(exp_msg=ofp.OFPT_FLOW_REMOVED, timeout=2)
...
class DeleteEmerFlow(base_tests.SimpleProtocol):
    ...
    def runTest(self):
        ...
        response = self.controller.poll(exp_msg=ofp.OFPFF_SEND_FLOW_REM, timeout=2)
        self.assertTrue(response is None, 
                        'Test Failed ')
...
class IdleTimeout(base_tests.SimpleDataPlane):
    ...
    def runTest(self):
        ...
        response = self.controller.poll(exp_msg=ofp.OFPT_FLOW_REMOVED, timeout=5)
        self.assertTrue(response is not None, 
...
class FlowTimeout(base_tests.SimpleDataPlane):
    ...
    def runTest(self):
        ...
        response = self.controller.poll(exp_msg=ofp.OFPT_FLOW_REMOVED, timeout=3)
        self.assertTrue(response is None, 
